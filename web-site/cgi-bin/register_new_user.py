...
user_exist_query = "SELECT userName FROM proj1.login WHERE userName=\'" + username + "\'"
user_ex_cur = cnx.cursor()
user_ex_cur.execute(user_exist_query)
...
insert_customerID = "INSERT INTO proj1.customers VALUES (default, \'" + firstName + "\', \'" + lastName + "\', 1, 0 )"
insert_cus_cur = cnx.cursor()
insert_cus_cur.execute(insert_customerID)
...
get_new_cusID_cur.execute(get_user_id)
