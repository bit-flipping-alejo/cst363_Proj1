...
book_selected_flight_query = "INSERT INTO proj1.reservations VALUES (DEFAULT, %s , 1 , %s, 'Not Confirmed')"
book_cur = cnx.cursor()
book_cur.execute(book_selected_flight_query, ( curUserID , flightID ) )
book_cur.close()
