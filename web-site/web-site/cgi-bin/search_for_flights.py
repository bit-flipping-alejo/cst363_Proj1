...
get_res = "SELECT flightID, departureTime, departureDay, cost FROM proj1.flights WHERE (departureID = %s AND destinationID = %s)"
res_curs = cnx.cursor()
res_curs.execute(get_res, (cityFromID ,cityToID ))
